...
final class GitHubDeployments_Project_Create extends Command {
	...
	protected function configure(): void {
		...
		$this->addArgument( 'name', InputArgument::REQUIRED, 'The name of the project to create.' )
			->addOption( 'blog_id', null, InputOption::VALUE_REQUIRED, 'The ID of the blog to create the project in.' )
	...
	protected function interact( InputInterface $input, OutputInterface $output ): void {
		$server   = $this->blog_id;
		$question = new ConfirmationQuestion( "<question>Are you sure you want to create the GitHub Deployments project `$this->name` on blog_id $server? [y/N]</question> ", false );
	...
	protected function execute( InputInterface $input, OutputInterface $output ): int {
		$server = $this->blog_id;
		$output->writeln( "<fg=magenta;options=bold>Creating GitHub Deployments project `$this->name` on blog_id $server.</>" );
